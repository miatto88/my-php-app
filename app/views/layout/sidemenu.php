<?php if ($_SESSION["member"]["role"] === Member::ROLE_GUEST): ?>
    <section class="side">
        ...
        <span class="side_menu"><a href="storing.php" style="color:grey; pointer-events:none;">入庫処理</a></span>
        <span class="side_menu"><a href="shipping.php" style="color:grey; pointer-events:none;">出庫処理</a></span>
